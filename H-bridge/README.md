Данное приложение разработано для управления двигателем постоянного тока при помощи транзисторов. Реализована функция setDirection для управления скоростью и направлением вращения.
